...
pub = rospy.Publisher('mic_data', Int16MultiArray, queue_size=10) #publisher sul topic mic_data
...
print("Recording...")
stop_listening = r.listen_in_background(m, callback) #ascolta continuamente in background, quando rileva l'audio chiama la callback
